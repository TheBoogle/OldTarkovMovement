...
public class OldJumpState : MovementState
{
    ...
    public override void Enter(bool isFromSameState)
    {
        ...
        this.ejumpState_0 = EJumpState.PushingFromTheGround;
    ...
    public override void ManualAnimatorMoveUpdate(float deltaTime)
    {
        ...
        if (this.ejumpState_0 == EJumpState.PushingFromTheGround)
        {
            if (!this.MovementContext.HeadBump(this.vector3_2.y * deltaTime) && this.float_2 <= 2f + this.float_3)
            {
                ...
                {
                    this.ejumpState_0 = EJumpState.Jump;
                }
            }
            else
            {
        ...
        else if (this.ejumpState_0 == EJumpState.Jump)
        {
    ...
    private void method_0()
    {
        this.MovementContext.PlayerAnimatorEnableJump(false);
        this.MovementContext.PlayerAnimatorEnableLanding(true);
        this.ejumpState_0 = EJumpState.Bumbped;
    }
    ...
    private void method_1(float deltaTime)
    {
        ...
        if (this.ejumpState_0 == EJumpState.Bumbped)
        {
    ...
    protected EJumpState ejumpState_0;
